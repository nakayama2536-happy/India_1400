...
def main():
    ...
    market["note"]="v4.9 decision-focused: v4.8 guidance/forecast plus compact indicator charts and external-indicator history."
    ...
    market["chart_data"]={"available":bool(nifty_charts.get("available")),"method_version":CHART_METHOD_VERSION,"window_trading_days":CHART_WINDOW,"nifty":nifty_charts,"external":ext,"external_history_note":"USD/INR・Brent・India VIXはv4.9以降の取得値を蓄積して表示します。"}
    nf=cf.get("nifty") or {}
