const CACHE = "india1400-v5-17-20260926-fund-yen-tranche";
const SHELL = ["./?v=5.17", "index.html", "manifest.webmanifest", "apple-touch-icon.png", "icon-192.png", "icon-512.png"];
